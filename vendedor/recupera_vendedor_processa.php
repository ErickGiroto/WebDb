...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("SELECT resposta1, resposta2, resposta3 FROM vendedores WHERE email = ?");
    ...
    if (password_verify($resposta1, $resposta1_hash) && password_verify($resposta2, $resposta2_hash) && password_verify($resposta3, $resposta3_hash)) {
        ...
        echo "Respostas incorretas. <a href='recupera_vendedor.php'>Tente novamente</a>";
    }
