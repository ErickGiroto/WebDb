...
<body>
    <div class="form-container">
        <form action="cadastro_vendedor_processa.php" method="POST">
            ...
            <input type="text" name="cnpj" placeholder="CNPJ (xx.xxx.xxx/xxxx-xx)" pattern="\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2}" required>
            <input type="date" name="data_nascimento" placeholder="Data de Nascimento da Empresa" required>
