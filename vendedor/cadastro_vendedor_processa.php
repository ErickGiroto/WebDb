<?php
// cadastro_vendedor_processa.php
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO vendedores 
        (nome_completo, email, senha, cnpj, rua, numero, complemento, bairro, cidade, estado, pais, celular, telefone, data_nascimento, dados_bancarios, 
    ...
    if ($stmt->execute()) {
        echo "Cadastro de vendedor realizado com sucesso! <a href='login_vendedor.php'>Fazer Login</a>";
    } else {
